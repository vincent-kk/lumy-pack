...
describe('fractal-navigate tool', () => {
  const sampleEntries: NodeEntry[] = [
    { name: 'src', path: '/app/src', type: 'directory', hasClaudeMd: true, hasSpecMd: false },
    { name: 'auth', path: '/app/src/auth', type: 'directory', hasClaudeMd: true, hasSpecMd: true },
    { name: 'utils', path: '/app/src/utils', type: 'organ', hasClaudeMd: false, hasSpecMd: false },
    { name: 'components', path: '/app/src/components', type: 'organ', hasClaudeMd: false, hasSpecMd: false },
  ];
