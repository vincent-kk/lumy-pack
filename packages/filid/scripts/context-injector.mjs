...
var require_braces = __commonJS({
  "../../node_modules/braces/index.js"(exports, module) {
    ...
    braces.expand = (input2, options = {}) => {
      ...
      let result2 = expand(input2, options);
  ...
  "../../node_modules/micromatch/node_modules/picomatch/lib/picomatch.js"(exports, module) {
    ...
    var picomatch = (glob, options, returnState = false) => {
      ...
      const matcher = (input2, returnObject = false) => {
        ...
        const result2 = { glob, state, regex, posix, input: input2, output, match, isMatch };
  ...
  try {
    ...
    try {
      ...
      if (highPriority.length > 0) {
        const driftLines = highPriority.slice(0, 5).map((d) => `- ${d.path} \u2014 ${d.expected} (expected: ${d.actual})`).join("\n");
        driftText = `
