...
export const COMMANDS: Record<string, CommandInfo> = {
  ...
  wizard: {
    ...
    options: [
      { flag: '-p, --print', description: 'Print prompt instead of invoking Claude Code' },
    ],
    examples: [
  ...
  restore: {
    ...
    arguments: [
      { name: 'filename', description: 'Backup file to restore (optional, interactive if omitted)', required: false },
    ],
    options: [
      { flag: '--dry-run', description: 'Show restore plan without actually restoring' },
    ],
    examples: [
  ...
  provision: {
    ...
    arguments: [
      { name: 'template', description: 'Template name to execute', required: true },
    ],
    options: [
      { flag: '--dry-run', description: 'Show execution plan without running commands' },
      { flag: '--skip-restore', description: 'Skip automatic config restore after provisioning' },
    ],
    examples: [
  ...
  'create-template': {
    ...
    arguments: [
      { name: 'name', description: 'Template filename (optional, generated from template name if omitted)', required: false },
    ],
    options: [
      { flag: '-p, --print', description: 'Print prompt instead of invoking Claude Code' },
    ],
  ...
  list: {
    ...
    arguments: [
      { name: 'type', description: 'Filter by type: "backups" or "templates" (optional)', required: false },
    ],
    options: [
      { flag: '--delete <n>', description: 'Delete item number n' },
    ],
    examples: [
  ...
  help: {
    ...
    arguments: [
      { name: 'command', description: 'Command to get detailed help for (optional)', required: false },
    ],
    examples: [
