# lumy-pack — agent instructions

Repository overview, commands, conventions and the always/ask/never lists live in [CLAUDE.md](CLAUDE.md). This file holds only what CLAUDE.md does not say. The `FILID` and `SEIRI` blocks below are generated from `.claude/rules/` by their plugins; do not edit them by hand.
